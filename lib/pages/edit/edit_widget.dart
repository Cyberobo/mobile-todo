        ...
        children: [
          Padding(
            ...
            child: FutureBuilder<ApiCallResponse>(
              future: TodoApiGroup.getTaskByIdCall.call(
              ...
              builder: (context, snapshot) {
                ...
                final containerGetTaskByIdResponse = snapshot.data!;
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.yourNameTextController1 ??=
                                ...
                                text: TodoModelStruct.maybeFromMap(
                                        containerGetTaskByIdResponse.jsonBody)
                                    ?.title,
                              ),
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.apiResultokh =
                                      await TodoApiGroup.updateTaskCall.call(
                                    title: _model.yourNameTextController1.text,
                                    description:
                                        _model.yourNameTextController2.text,
                                    id: widget.index?.toString(),
                                  );

                                  if ((_model.apiResultokh?.succeeded ??
                                      true)) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        ...
                                        backgroundColor: Color(0xFF48DA40),
                                      ),
                                    );
                                    _model.completedTasks = await TodoApiGroup
                                        .getComplatedTaskCall
                                        .call();

                                    FFAppState().completedTaskList =
                                        ((_model.completedTasks?.jsonBody ?? '')
                                                    .toList()
                                                    .map<TodoModelStruct?>(
                                                        TodoModelStruct
                                                            .maybeFromMap)
                                                    .toList()
                                                as Iterable<TodoModelStruct?>)
                                            .withoutNulls
                                            .toList()
                                            .cast<TodoModelStruct>();
                                    FFAppState().update(() {});
                                    _model.pendingTasks = await TodoApiGroup
                                        .getPendingTaskCall
                                        .call();

                                    FFAppState().pendingTaskList =
                                        ((_model.pendingTasks?.jsonBody ?? '')
                                                    .toList()
                                                    .map<TodoModelStruct?>(
                                                        TodoModelStruct
                                                            .maybeFromMap)
